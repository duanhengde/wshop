...
public class TGoodsDAO extends HibernateDaoSupport {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TGoods instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from TGoods as model where model." + propertyName + "= ?";
	...
	public TGoods merge(TGoods detachedInstance) {
		...
		try {
			TGoods result = (TGoods) getHibernateTemplate().merge(detachedInstance);
