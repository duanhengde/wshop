...
public class TCatelogDAO extends HibernateDaoSupport {
	...
	public TCatelog findById(java.lang.Integer id) {
		...
		try {
			TCatelog instance = (TCatelog) getHibernateTemplate().get("com.model.TCatelog", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TCatelog instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from TCatelog as model where model." + propertyName + "= ?";
	...
	public TCatelog merge(TCatelog detachedInstance) {
		...
		try {
			TCatelog result = (TCatelog) getHibernateTemplate().merge(detachedInstance);
