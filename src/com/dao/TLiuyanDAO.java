...
public class TLiuyanDAO extends HibernateDaoSupport {
	...
	public TLiuyan findById(java.lang.Integer id) {
		...
		try {
			TLiuyan instance = (TLiuyan) getHibernateTemplate().get("com.model.TLiuyan", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TLiuyan instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from TLiuyan as model where model." + propertyName + "= ?";
	...
	public TLiuyan merge(TLiuyan detachedInstance) {
		...
		try {
			TLiuyan result = (TLiuyan) getHibernateTemplate().merge(detachedInstance);
