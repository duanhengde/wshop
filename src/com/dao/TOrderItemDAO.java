...
public class TOrderItemDAO extends HibernateDaoSupport {
	...
	public TOrderItem findById(java.lang.Integer id) {
		...
		try {
			TOrderItem instance = (TOrderItem) getHibernateTemplate().get("com.model.TOrderItem", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TOrderItem instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from TOrderItem as model where model." + propertyName + "= ?";
	...
	public TOrderItem merge(TOrderItem detachedInstance) {
		...
		try {
			TOrderItem result = (TOrderItem) getHibernateTemplate().merge(detachedInstance);
