...
public class TAdminDAO extends HibernateDaoSupport {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TAdmin instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from TAdmin as model where model." + propertyName + "= ?";
	...
	public TAdmin merge(TAdmin detachedInstance) {
		...
		try {
			TAdmin result = (TAdmin) getHibernateTemplate().merge(detachedInstance);
