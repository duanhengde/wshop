...
public class TOrderDAO extends HibernateDaoSupport {
	...
	public TOrder findById(java.lang.Integer id) {
		...
		try {
			TOrder instance = (TOrder) getHibernateTemplate().get("com.model.TOrder", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding TOrder instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from TOrder as model where model." + propertyName + "= ?";
