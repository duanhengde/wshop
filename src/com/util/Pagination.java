...
public class Pagination {
	...
	public String getPageDisplay() {
		...
		if (index == 0 || pageSize == 0) {
			...
			displayInfo.append("共" + totle + "条记录&nbsp;&nbsp;&nbsp;&nbsp;每页<span style='color:#FF0000'>" + pageSize
					+ "</span>条&nbsp;&nbsp;&nbsp;&nbsp;");
			displayInfo.append("第<span style='color:#FF0000'>" + index + "</span>页/共" + this.getTotlePage()
					+ "页&nbsp;&nbsp;&nbsp;&nbsp;");
			...
			if (index >= this.getTotlePage()) {
				...
				displayInfo.append(
						"<a href='" + path + "index=" + this.getTotlePage() + "'>末页</a>&nbsp;&nbsp;&nbsp;&nbsp;");
			}
			displayInfo.append("</div>");
		}
