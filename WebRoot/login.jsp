...
<body>
	...
	<br>
	<br>
	<table width="650px" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/img/dfff.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 33pt;">&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
	 </tr>
	 <tr>
		<td width="650px">
			<form name="ThisForm" method="POST" action="">
				<table width="360" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
					<tr>
						<td height="10" colspan="2"></td>
					</tr>
			        <tr>
					    <td width="100" height="22" align="right"  valign="bottom">
					...
					<tr>
						<td height="22"  valign="top" class="STYLE15" align="right"  valign="bottom">
						     密&nbsp;&nbsp;&nbsp;&nbsp;码：
						    </td>
						<td width="260" valign="bottom"> 
