 ...
 function callback(data)
 {
	...
	function keyLogin() {
		if (event.keyCode == 13) //回车键的键值为13
			document.getElementByIdx_x(check1()).click(); //调用登录按钮的登录事件
	}
</script>
</head>
			...
			<td width="650px">
				<form name="ThisForm" method="POST" action="">
					<table width="360" height="198" border="0" align="right"
						...
						<tr>
							<td width="100" height="22" align="right" valign="bottom"><span
								class="STYLE15">用户名：</span></td>
							<td width="260" valign="bottom"><input name="userName"
