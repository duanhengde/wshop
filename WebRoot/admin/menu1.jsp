...
<html>
  <head>
	...
	<style type="text/css">
		...
		body {
		 scrollbar-base-color:#C27E73;
		 scrollbar-arrow-color:#FFFFFF;
		 scrollbar-shadow-color:#D2A097;
		 padding:0px;
		 margin:auto;
		 text-align:center;
	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0' style="background-color:#c0c0c0;">
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
		  <!-- 1 -->
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b>后台人员管理</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/index/adminAdd.jsp' target='main'>后台人员添加</a> </li>
	            <li><a href='<%=path %>/adminManage.action' target='main'>后台人员维护</a> </li>
	          </ul>
	        </dd>
	      </dl>
		</td>
